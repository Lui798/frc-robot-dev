...
public class DriveSystem
{
    ...
    */
    ...
    private static DifferentialDrive wheelsMotor1 = new DifferentialDrive(new PWMVictorSPX(0), new PWMVictorSPX(2));
    //The opposite of the wheelsMotor1.
    private static DifferentialDrive wheelsMotor2 = new DifferentialDrive(new PWMVictorSPX(1), new PWMVictorSPX(3)); 
